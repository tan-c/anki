...
// You should not save hot update or bundle.js in development,
// const jsCssPolicy = window.location.href.indexOf('localhost') > -1 ? new RegExp('sw.js') : /\.(?:js|css)$/;
