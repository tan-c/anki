...
// curtesy from https://www.npmjs.com/package/quill-image-drop-module
export class ImageDrop {
   ...
   */
  handlePaste(evt) {
    // FIXME: basically this is not working in safari
    // In chrome you will past the file name
    // UPDATE: in chrome it works from Evernote
